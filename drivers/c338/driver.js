...
class C338Driver extends Homey.Driver {
  ...
  onPair(socket) {
    ...
    socket.on('get_devices', function (data, callback) {
      ...
      console.log("NAD C338 app - get_devices data: " + JSON.stringify(data));
    ...
    socket.on('list_devices', function (data, callback) {
      console.log("NAD C338 app - get_devices data: " + JSON.stringify(data));
      console.log("NAD C338 app - list_devices data: " + JSON.stringify(data));
      console.log("NAD C338 app - list_devices devices: " + JSON.stringify(devices));
    ...
    socket.on('disconnect', function () {
      console.log("NAD C338 app - Pairing is finished (done or aborted)"); // using console.log because this.log or Homey.log is not a function
    })
